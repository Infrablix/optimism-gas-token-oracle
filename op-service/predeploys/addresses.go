...
const (
	...
	CustomGasTokenPriceOracle     = "0x42000000000000000000000000000000000007fe" // increment address backwards
...
var (
	...
	CustomGasTokenPriceOracleAddr     = common.HexToAddress(CustomGasTokenPriceOracle)
...
func init() {
	...
	Predeploys["CustomGasTokenPriceOracle"] = &Predeploy{Address: CustomGasTokenPriceOracleAddr}
